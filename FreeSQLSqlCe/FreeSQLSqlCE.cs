...
{
   public class FreeSQLSqlCE : FreeSQLDatabase
   {
      private readonly ILogger LogDatabase;

      private SqlCeConnection _conn;
      private SqlCeTransaction _trans;

      public FreeSQLSqlCE(string dbConnString, ILogger dbLogger)
      {
      ...
      internal protected SqlCeConnection CurrentConnection
      {
         get { return _conn; }
      }

      internal protected SqlCeTransaction CurrentTransaction
      {
         get { return _trans; }
      }
      ...
      {
         var operation = new UpdateSpecialSqlCeOperation<T>(obj, column, _conn, _trans);
         operation.Execute();
      }
      ...
      {
         var operation = new SelectSqlCeOperation<T>(codObj, _conn, _trans);
         operation.Execute();
      ...
      {
         var operation = new SelectSpecialSqlCeOperation<T>(column, comparison, value, _conn, _trans);
         operation.Execute();
         return operation.ReturnObjects;
      }
      ...
      {
         var operation = new SelectSpecialSqlCeOperation<T>(columns, comparison, values, _conn, _trans);
         operation.Execute();
         return operation.ReturnObjects;
      }
      ...
      {
         var operation = new SelectTopSqlCeOperation<T>(rows, column, desc, _conn, _trans);
         operation.Execute();
         return operation.ReturnObjects;
      }
      ...
      {
         var operation = new SelectTopWhereSqlCeOperation<T>(rows, fColumn, comparison, value, sColumn, desc, _conn, _trans);
         operation.Execute();
         return operation.ReturnObjects;
      }
      ...
      {
         var operation = new SelectTopSqlCeOperation<T>(rows, columns, descs, _conn, _trans);
         operation.Execute();
         return operation.ReturnObjects;
      }
      ...
      {
         var operation = new SelectTopWhereSqlCeOperation<T>(rows, fColumns, comparison, values, sColumns, desc, _conn, _trans);
         operation.Execute();
         return operation.ReturnObjects;
      }
      ...
      {
         var operation = new SelectValueSqlCeOperation<T>(commandText, parameters, _conn, _trans);
         operation.Execute();
