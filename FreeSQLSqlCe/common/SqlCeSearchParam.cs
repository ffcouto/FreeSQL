...
{
   public class SqlCeSearchParam : SearchParam
   {
      public SqlCeSearchParam(string fieldName, string fieldText, string paramName, SearchComparison comparison, object dataType, bool needCriteria)
      {
         FieldName = fieldName;
         FieldText = fieldText;
         ParamName = paramName;
