...
namespace FreeSQL.Common
{
   public class SqlCeSearchEngine : SearchEngine
   {
      ...
      {
         _filters.Add(new SqlCeSearchParam(name, text, param, comparison, dataType, needCriteria));
      }
      ...
      {
         _filters.Add(new SqlCeSearchParam(name, text, name, comparison, dataType, needCriteria) { Value = value });
      }
      ...
      {
         _filters.Add(new SqlCeSearchParam(name, text, param, comparison, dataType, needCriteria) { Value = value });
      }

      public override void AddHiddenFilter(string name, string text, SearchComparison comparison, object dataType, object value)
      {
         _filters.Add(new SqlCeSearchParam(name, text, name, comparison, dataType, true) { Hidden = true, Value = value });
      }
      ...
      {
         _filters.Add(new SqlCeSearchParam(name, text, param, comparison, dataType, true) { Hidden = true, Value = value });
      }
      ...
      {
         _filters.Add(new SqlCeSearchParam(name, text, name, comparison, dataType, needCriteria) { Hidden = true, Value = value });
      }
      ...
      {
         _filters.Add(new SqlCeSearchParam(name, text, param, comparison, dataType, needCriteria) { Hidden = true, Value = value });
      }

      public static SearchParam NullParam()
      {
         return new SqlCeSearchParam("", "", "", SearchComparison.None, null, false);
      }

      public static SearchParam CreateParam(string name, string text, string param, SearchComparison comparison, object dataType)
      {
         return new SqlCeSearchParam(name, text, param, comparison, dataType, true);
      }
      ...
      {
         return new SqlCeSearchParam(name, text, param, comparison, dataType, true) { Value = value };
      }
      ...
      {
         return new SqlCeSearchParam(name, text, param, comparison, dataType, needCriteria);
      }
      ...
      {
         return new SqlCeSearchParam(name, text, param, comparison, dataType, needCriteria) { Value = value };
      }
   }
}
