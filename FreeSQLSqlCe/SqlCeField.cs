...
namespace FreeSQL.Backwork
{
   ...
   public sealed class SqlCeField : Field
   {
      public SqlCeField(int tableIndex, string fieldName, SqlDbType dataType)
         : this(tableIndex, fieldName, dataType, true)
      { }

      public SqlCeField(int tableIndex, string fieldName, SqlDbType dataType, bool visible)
      {
