...
{
   internal class SelectAllSqlOperation<T> : SqlCeOperation
   {
      // local variables
      private readonly string wOrderField;
      private T[] retObjs = new T[] { };

      public SelectAllSqlOperation(string orderField, SqlCeConnection connection, SqlCeTransaction transaction)
      ...
      private SqlCeCommand GetSelectAllCommand(string sortField)
      {
