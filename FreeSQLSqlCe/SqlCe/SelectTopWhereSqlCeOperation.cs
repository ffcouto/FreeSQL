...
{
   internal class SelectTopWhereSqlCeOperation<T> : SqlCeOperation
   {
      // local variables
      ...
      public SelectTopWhereSqlCeOperation(int rows, string fColumn, string comparison, object value, string sColumn, bool desc, SqlCeConnection connection, SqlCeTransaction transaction)
      ...
      public SelectTopWhereSqlCeOperation(int rows, string[] fColumns, string[] comparison, object[] values, string[] sColumns, bool[] desc, SqlCeConnection connection, SqlCeTransaction transaction)
         : base(connection, transaction)
      {
         wRows = rows;
      ...
      private SqlCeCommand GetSelectTopCommand(int topRows, string[] fColumns, string[] comparison, object[] values, string[] sColumns, bool[] descs)
      {
