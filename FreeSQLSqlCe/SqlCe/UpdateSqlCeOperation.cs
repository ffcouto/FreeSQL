...
{
   internal class UpdateSqlOperation<T> : SqlCeOperation
   {
      // local variables
      private readonly T obj;

      public UpdateSqlOperation(T obj, SqlCeConnection connection, SqlCeTransaction transaction)
      ...
      private SqlCeCommand GetUpdateCommand(T obj, Table t)
      {
