...
{
   internal class SelectValueSqlCeOperation<T> : SqlCeOperation
   {
      // local variables
      ...
      public SelectValueSqlCeOperation(string commandText, SearchParam[] parameters, SqlCeConnection connection, SqlCeTransaction transaction)
