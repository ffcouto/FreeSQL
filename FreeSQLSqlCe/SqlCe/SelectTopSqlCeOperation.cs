...
{
   internal class SelectTopSqlCeOperation<T> : SqlCeOperation
   {
      // local variables
      ...
      public SelectTopSqlCeOperation(int rows, string column, bool desc, SqlCeConnection connection, SqlCeTransaction transaction)
      ...
      public SelectTopSqlCeOperation(int rows, string[] columns, bool[] desc, SqlCeConnection connection, SqlCeTransaction transaction)
         : base(connection, transaction)
      {
         wRows = rows;
         wColumns = columns;
      ...
      private SqlCeCommand GetSelectTopCommand(int topRows, string[] columns, bool[] descs)
      {
