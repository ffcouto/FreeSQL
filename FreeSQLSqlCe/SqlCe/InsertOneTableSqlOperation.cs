...
{
   internal class InsertOneTableSqlOperation<T> : SqlCeOperation
   {
      // local variables
      ...
      public InsertOneTableSqlOperation(T obj, int tableIndex, SqlCeConnection connection, SqlCeTransaction transaction)
