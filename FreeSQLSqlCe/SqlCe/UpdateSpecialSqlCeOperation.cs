...
{
   internal class UpdateSpecialSqlCeOperation<T> : SqlCeOperation
   {
      // local variables
      private readonly T wObj;
      private readonly string wColumn;

      public UpdateSpecialSqlCeOperation(T obj, string column, SqlCeConnection connection, SqlCeTransaction transaction)
      ...
      public override void Execute()
      {
         try
         {
            ...
            var sf = pk.GetCustomAttributes(true).Where(a => a.GetType() == typeof(SqlCeField)).Cast<SqlCeField>().ToArray();
      ...
      private SqlCeCommand GetUpdateSpecialCommand(T obj, Table t, string column)
      {
