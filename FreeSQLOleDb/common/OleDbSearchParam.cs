...
namespace FreeSQL.Common
{
   ...
   {
      public OleDbSearchParam(string fieldName, string fieldText, SearchComparison comparison, object dataType)
      {
      ...
      public string FormattedExpression
      {
         get
         {
            ...
            {
               return string.Format("({0} {1} ?)", this.FieldName, this.Comparison.GetDescription());
            }
         }
      }
