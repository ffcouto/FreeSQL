...
namespace FreeSQL.Common
{
   public class OleDbSearchEngine : SearchEngine
   {
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, param, comparison, dataType, true));
      }
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, param, comparison, dataType, needCriteria));
      }
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, name, comparison, dataType, needCriteria) { Value = value });
      }
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, param, comparison, dataType, needCriteria) { Value = value });
      }

      public override void AddHiddenFilter(string name, string text, SearchComparison comparison, object dataType, object value)
      {
         _filters.Add(new OleDbSearchParam(name, text, name, comparison, dataType, true) { Hidden = true, Value = value });
      }
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, param, comparison, dataType, true) { Hidden = true, Value = value });
      }
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, name, comparison, dataType, needCriteria) { Hidden = true, Value = value });
      }
      ...
      {
         _filters.Add(new OleDbSearchParam(name, text, param, comparison, dataType, needCriteria) { Hidden = true, Value = value });
      }

      public static SearchParam NullParam()
      {
         return new OleDbSearchParam("", "", "", SearchComparison.None, null, false);
      }

      public static SearchParam CreateParam(string name, string text, SearchComparison comparison, object dataType)
      {
         return new OleDbSearchParam(name, text, name, comparison, dataType, true);
      }
      ...
      {
         return new OleDbSearchParam(name, text, param, comparison, dataType, true) { Value = value };
      }
      ...
      {
         return new OleDbSearchParam(name, text, param, comparison, dataType, needCriteria) { Value = value };
      }
   }
}
